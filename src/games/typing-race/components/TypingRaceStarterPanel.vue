<template>
  <section class="starter-panel">
    ...
    <p class="starter-copy">
      Starter page for timed prompts, live words-per-minute scoring, multiplayer races, and accuracy analytics.
    </p>
...
.starter-panel {
  ...
  border-radius: 28px;
  background: linear-gradient(180deg, rgba(91, 62, 150, 0.14), rgba(255, 255, 255, 0.95));
}
